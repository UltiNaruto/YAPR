...
{
    public static class SeparateKraidPickupsFromDeath
    {
                        ...
                        if (Room_Transition_Timer <= 0)
                        {
                            if (obj_MAIN.Screen_X == 7 && obj_MAIN.Screen_Y == 28 && !instance_exists(obj_Boss_Kraid))
                            {
                                with(par_Item)
                                {
                                    ...
                                    {
                                        if (id == 100083 && ds_map_find_value(ds_list_find_value(ds_map_find_value(global.SAVE_BACKUP, "ITEMS"), 38), "collected") == 0)
                                            Active = 1
                                        if (id == 100084 && ds_map_find_value(ds_list_find_value(ds_map_find_value(global.SAVE_BACKUP, "ITEMS"), 39), "collected") == 0)
                                            Active = 1
                                    }
                                }
                            }
        ...
        static void AddTourianKeyToRoom(UndertaleData gmData)
        {
            ...
            // Events
            var obj_Item_Kraid_Key_Create_0_code_str = new UndertaleString("gml_Object_obj_Item_Kraid_Key_Create_0");
            gmData.Strings.Add(obj_Item_Kraid_Key_Create_0_code_str);
            ...
            var obj_Item_Kraid_Key_PreCreate_0_code_str = new UndertaleString("gml_Object_obj_Item_Kraid_Key_PreCreate_0");
            gmData.Strings.Add(obj_Item_Kraid_Key_PreCreate_0_code_str);

            var obj_Item_Kraid_Key_PreCreate_0_code = new UndertaleCode();
            obj_Item_Kraid_Key_PreCreate_0_code.Name = obj_Item_Kraid_Key_PreCreate_0_code_str;
            obj_Item_Kraid_Key_PreCreate_0_code.ReplaceGML("event_inherited()\n", gmData);

            gmData.Code.Add(obj_Item_Kraid_Key_PreCreate_0_code);

            var obj_Item_Kraid_Key_Step_0_code_str = new UndertaleString("gml_Object_obj_Item_Kraid_Key_Step_0");
            gmData.Strings.Add(obj_Item_Kraid_Key_Step_0_code_str);
            ...
            // Object creation
            var obj_Item_Kraid_Key_str = new UndertaleString("obj_Item_Kraid_Key");
            gmData.Strings.Add(obj_Item_Kraid_Key_str);

            var obj_Item_Kraid_Key_Create_0 = new UndertaleGameObject.Event();
            obj_Item_Kraid_Key_Create_0.Actions.Add(new UndertaleGameObject.EventAction()
            {
                CodeId = obj_Item_Kraid_Key_Create_0_code
            });

            var obj_Item_Kraid_Key_PreCreate_0 = new UndertaleGameObject.Event();
            obj_Item_Kraid_Key_PreCreate_0.Actions.Add(new UndertaleGameObject.EventAction()
            {
                CodeId = obj_Item_Kraid_Key_PreCreate_0_code
            });

            var obj_Item_Kraid_Key_Step_0 = new UndertaleGameObject.Event();
            obj_Item_Kraid_Key_Step_0.Actions.Add(new UndertaleGameObject.EventAction()
            {
                CodeId = obj_Item_Kraid_Key_Step_0_code
            });

            var obj_Item_Kraid_Key = new GameObject();
            obj_Item_Kraid_Key.X = 1848;
            obj_Item_Kraid_Key.Y = 6888;
            obj_Item_Kraid_Key.ObjectDefinition = obj_Item_Tourian_Key;
            obj_Item_Kraid_Key.ObjectDefinition.Name = obj_Item_Kraid_Key_str;
            obj_Item_Kraid_Key.ObjectDefinition.Events[(int)EventType.Create].Add(obj_Item_Kraid_Key_Create_0);
            obj_Item_Kraid_Key.ObjectDefinition.Events[(int)EventType.PreCreate].Add(obj_Item_Kraid_Key_PreCreate_0);
            obj_Item_Kraid_Key.ObjectDefinition.Events[(int)EventType.Step].Add(obj_Item_Kraid_Key_Step_0);
            obj_Item_Kraid_Key.ObjectDefinition.Sprite = gmData.Sprites.FirstOrDefault(spr => spr.Name.Content == "spr_ITEM_Tourian_Key");
            obj_Item_Kraid_Key.InstanceID = 100083;
            obj_Item_Kraid_Key.ScaleX = 1;
            obj_Item_Kraid_Key.ScaleY = 1;
            obj_Item_Kraid_Key.Color = 0xFFFFFFFF;
            obj_Item_Kraid_Key.Rotation = 0;

            gmData.GameObjects.Add(obj_Item_Kraid_Key.ObjectDefinition);
            gmData.Rooms[5].GameObjects.Add(obj_Item_Kraid_Key);
            gmData.Rooms[5].Layers[4].InstancesData.Instances.Add(obj_Item_Kraid_Key);
        }
        ...
        static void AddBigMissileTankToRoom(UndertaleData gmData)
        {
            ...
            // Object creation
            var obj_Item_Big_Missile_str = new UndertaleString("obj_Item_Kraid_Big_Missile");
            ...
            obj_Item_Big_Missile.X = 1976;
            obj_Item_Big_Missile.Y = 6888;
            ...
            obj_Item_Big_Missile.InstanceID = 100084;
